# The code implementing Perlin noise is taken from Rosetta Code and is
# available under GNU FDL 1.2
# https://rosettacode.org/wiki/Perlin_noise#Julia
...
function two_phase_noise()
    noise = [perlinnoise(x/10, y/10, z/10) for x in 1:50, y in 1:50, z in 1:50]
